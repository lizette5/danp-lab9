                ...
                videoCapture.startRecording(
                        ...
                        new VideoCapture.OnVideoSavedCallback() {
                            ...
                            public void onVideoSaved(@NonNull VideoCapture.OutputFileResults outputFileResults) {
                                Toast.makeText(MainActivity.this, "VIDEO SE HA GUARDADO... ", Toast.LENGTH_SHORT).show();
                            }

                            @Override
                            public void onError(int videoCaptureError, @NonNull String message, @Nullable Throwable cause) {
                                Toast.makeText(MainActivity.this, "ERROR AL GUARDAR VIDEO... " + message, Toast.LENGTH_SHORT).show();
                            }
                        }
                );
            } catch (Exception e) {
        ...
        imageCapture.takePicture(
                ...
                new ImageCapture.OnImageSavedCallback() {
                    ...
                    public void onImageSaved(@NonNull ImageCapture.OutputFileResults outputFileResults) {
                        Toast.makeText(MainActivity.this, "FOTO SE HA GUARDADA...", Toast.LENGTH_SHORT).show();
                    }
